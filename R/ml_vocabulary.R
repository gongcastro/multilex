...
#' @details This function generates a data frame with the vocabulary of each participant
#' (keeping longitudinal data from the same participant in different rows). Comprehensive
#'  and productive vocabulary sizes are computed as raw counts (`vocab_count`) and
#'  as proportions (`vocab_prop`, calculated from the total of items filled by the
