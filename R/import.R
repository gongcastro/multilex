...
import_formr_lockdown <- function(
  ...
  suppressMessages({
    ...
    items_to_keep <- c(
      ...
      "language_doe_spanish_american",
      "language_doe_catalan_barcelona",
      "language_doe_catalan_majorca",
      "language_doe_catalan_other"
    )
    ...
    processed <- processed %>%
      ...
      select(
        ...
        .data$postcode, .data$sex, starts_with("edu_"), .data$language_doe_catalan,
        .data$language_doe_spanish, .data$language_doe_others, .data$language_doe_catalan_lockdown,
        .data$language_doe_spanish_lockdown, .data$language_doe_others_lockdown, matches("cat_|spa_")
      ) %>%
  ...
  suppressMessages({
    ...
    processed <- processed %>%
      ...
      select(
        ...
        .data$randomisation,
        .data$time_stamp,
        .data$date_birth, .data$age,
        .data$sex,
        .data$postcode,
        starts_with("edu_"),
        .data$language_doe_catalan,
        .data$language_doe_spanish,
        matches("cat_|spa_")
      ) %>%
      pivot_longer(
